...
<div class="row">
   <form class="form-horizontal" action="{{ route('eaps.academic_plans.store', ['eap' => $eap->getId() ]) }}" method="POST">
      {!! csrf_field() !!}
      ...
      <div class="form-container">
         ...
         <div class="form-group">
            ...
            <div class="col-xs-3 col-xs-offset-1 col-sm-2">
               <div class="checkbox">
                  <label>
                     <input type="checkbox" name="is_active" {{ old('year_of_publication') ? 'checked' : ''}}> ¿Está activo?
                  </label>
               </div>
            </div>
